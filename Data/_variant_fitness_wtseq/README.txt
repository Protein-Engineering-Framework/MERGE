...
are taken from Supplementary Information, Supplementary Table 2, of Hopf et al., 
        ...
        https://static-content.springer.com/esm/art%3A10.1038%2Fnbt.3769/MediaObjects/41587_2017_BFnbt3769_MOESM13_ESM.xlsx ,
but contain a reduced content of variant fitness data, as some variants could not be encoded using the (plm)DCA approach, so that different 
encoding and modeling methods can be compared for the same data content.
